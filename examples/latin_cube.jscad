...
function getParameterDefinitions() {
  return [
    { name: 'length', caption: 'Length of the cube (number of blocks):', type: 'int', initial: 3, size: 5 },
	...
	//{ name: 'name', caption: 'Numbers for all blocks (a 0 means a sparse position):', type: 'text', initial: "123231312231312123312123231", size:30}
	{ name: 'name', caption: 'Numbers for all blocks (a 0 means a sparse position):', type: 'text', initial: "123456789456789123987654321", size:30},
	{ name: 'transparency', caption: 'Transparency:', type: 'float', initial: 0.4, size:10}
  ];
}
