...
function getParameterDefinitions() {
  return [
	...
	//{ name: 'name', caption: 'Numbers for all blocks (a 0 means a sparse position):', type: 'text', initial: "4321	3210	2100	1000	//3210	2100	1000	0210	01000	0000	0000	1000	0000	0000	0000", size:30},
